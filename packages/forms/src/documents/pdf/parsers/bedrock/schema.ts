...
/**
 * Bedrock LLM Parser Output Schema
 *
 * This schema defines the structure that the Bedrock LLM parser returns.
 * It represents one specific parser's interpretation of a PDF form.
 */
...
export const BedrockExtractedObject = z.object({
...
export type BedrockExtractedObject = z.infer<typeof BedrockExtractedObject>;
