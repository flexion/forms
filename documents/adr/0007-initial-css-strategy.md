...
The project team will theme USWDS via an encapsulated build (`@flexion/forms-design`). Any USWDS-related configuration or initialization will reside in this package.
...
There is a bit more pomp and circumstance required to leverage styles that are in a separate project (`@flexion/forms-design`) than there is when importing SASS directly via Astro.
